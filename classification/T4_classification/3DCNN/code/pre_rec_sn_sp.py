...
# Paths
base = r"path\to\Ensemble\T4_Classification\3DCNN"
pred_path  = base + r"\T4_vs_nonT4_Custom3DCNN_ensemble_predictions.csv"
metrics_js = base + r"\T4_vs_nonT4_Custom3DCNN_ensemble_test_metrics.json"
out_csv    = base + r"\T4_vs_nonT4_Custom3DCNN_raw_vs_calibrated_metrics.csv"
out_xlsx   = base + r"\T4_vs_nonT4_Custom3DCNN_raw_vs_calibrated_metrics.xlsx"
