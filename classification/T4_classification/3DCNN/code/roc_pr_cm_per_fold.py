# ========================================================
# Code to save ROC, P-R curve, confusion matrices per fold
# ========================================================
...
df = pd.read_csv(r"path\to\Ensemble\T4_Classification\3DCNN\T4_vs_nonT4_Custom3DCNN_ensemble_predictions.csv")  # y_true, prob_raw, prob_cal
...
with open(r"path\to\Ensemble\T4_Classification\3DCNN\T4_vs_nonT4_Custom3DCNN_ensemble_test_metrics.json", "r") as f:
    metrics = json.load(f)
t_opt = metrics["t_opt_ens"]             # ≈ 0.4760673
...
save_folder = r"path\to\Ensemble\T4_Classification\3DCNN"
