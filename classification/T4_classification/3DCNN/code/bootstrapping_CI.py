...
pred_path   = os.path.join(output_root, "T4_vs_nonT4_Custom3DCNN_ensemble_predictions.csv")
metrics_js  = os.path.join(output_root, "T4_vs_nonT4_Custom3DCNN_ensemble_test_metrics.json")
out_csv     = os.path.join(output_root, "Custom3DCNN_raw_and_calibrated_bootstrap_CIs.csv")
out_xlsx    = os.path.join(output_root, "Custom3DCNN_raw_and_calibrated_bootstrap_CIs.xlsx")
