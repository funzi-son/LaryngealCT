#=========================================
#ResNet101 ensemble test inference script
#=========================================
import os, json
...
# ------------------
cv_summary_path = Path(OUTPUT_ROOT) / "cv_summary_resnet101.json"
...
print("\n=== ENSEMBLE TEST RESULTS (ResNet101) ===")
...
pred_path = out_dir / "T4_vs_Non_T4_ResNet101_ensemble_predictions.csv"
...
metrics_path = out_dir / "T4_vs_Non_T4_ResNet101_ensemble_test_metrics.json"
