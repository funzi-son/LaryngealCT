...
df = pd.read_csv(r"path\to\Ensemble\T4_Classification\ResNet50_pretrained\T4_vs_Non_T4_ResNet50_pretrained_ensemble_predictions.csv")  # y_true, prob_raw, prob_cal
...
with open(r"path\to\Ensemble\T4_Classification\ResNet50_pretrained\T4_vs_Non_T4_ResNet50_pretrained_ensemble_test_metrics.json", "r") as f:
    metrics = json.load(f)
...
save_folder = r"path\to\Ensemble\T4_Classification\ResNet50_pretrained"
