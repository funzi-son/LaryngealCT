...
pred_path   = os.path.join(output_root, "T4_vs_Non_T4_ResNet18_ensemble_predictions.csv")
metrics_js  = os.path.join(output_root, "T4_vs_Non_T4_ResNet18_ensemble_test_metrics.json")
out_csv     = os.path.join(output_root, "T4_vs_Non_T4_ResNet18_raw_and_calibrated_bootstrap_CIs.csv")
out_xlsx    = os.path.join(output_root, "T4_vs_Non_T4_ResNet18_raw_and_calibrated_bootstrap_CIs.xlsx")
