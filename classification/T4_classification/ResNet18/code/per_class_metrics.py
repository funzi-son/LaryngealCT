...
output_root = Path(r"path\to\Ensemble\T4_Classification\ResNet18")
pred_path   = output_root / "T4_vs_Non_T4_ResNet18_ensemble_predictions.csv"
metrics_path = output_root / "T4_vs_Non_T4_ResNet18_ensemble_test_metrics.json"
...
out_csv = output_root / "T4_vs_Non_T4_ResNet18_per_class_from_ensemble.csv"
