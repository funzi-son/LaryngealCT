...
# Paths
base = r"path\to\Ensemble\T4_Classification\ResNet18"
pred_path  = base + r"\T4_vs_Non_T4_ResNet18_ensemble_predictions.csv"
metrics_js = base + r"\T4_vs_Non_T4_ResNet18_ensemble_test_metrics.json"
out_csv    = base + r"\T4_vs_Non_T4_ResNet18_raw_vs_calibrated_metrics.csv"
out_xlsx   = base + r"\T4_vs_Non_T4_ResNet18_raw_vs_calibrated_metrics.xlsx"
