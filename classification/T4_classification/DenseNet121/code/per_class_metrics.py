...
output_root = Path(r"path\to\Ensemble\T4_Classification\DenseNet121")
pred_path   = output_root / "T4_vs_Non_T4_DenseNet121_ensemble_predictions.csv"
metrics_path = output_root / "T4_vs_Non_T4_DenseNet121_ensemble_test_metrics.json"
...
out_csv = output_root / "T4_vs_Non_T4_DenseNet121_per_class_from_ensemble.csv"
