...
# Paths
base = r"path\to\Ensemble\T4_Classification\ResNet50"
pred_path  = base + r"\T4_vs_Non_T4_ResNet50_ensemble_predictions.csv"
metrics_js = base + r"\T4_vs_Non_T4_ResNet50_ensemble_test_metrics.json"
out_csv    = base + r"\T4_vs_Non_T4_ResNet50_raw_vs_calibrated_metrics.csv"
out_xlsx   = base + r"\T4_vs_Non_T4_ResNet50_raw_vs_calibrated_metrics.xlsx"
