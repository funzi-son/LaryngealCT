...
output_root = Path(r"path\to\Ensemble\T4_Classification\ResNet50")
pred_path   = output_root / "T4_vs_Non_T4_ResNet50_ensemble_predictions.csv"
metrics_path = output_root / "T4_vs_Non_T4_ResNet50_ensemble_test_metrics.json"
...
out_csv = output_root / "T4_vs_Non_T4_ResNet50_per_class_from_ensemble.csv"
