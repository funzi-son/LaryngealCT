#==================================================================================
#Code to generate combined RoC overlays for all six models (early vs advanced task)
#==================================================================================
import os
...
EXPERIMENTS = [
    ...
    ("3DCNN",              r"path\to\Ensemble\Binary\3DCNN",          "Early_vs_Advanced_Custom3DCNN_ensemble_predictions.csv"),
    ("ResNet18",           r"path\to\Ensemble\Binary\ResNet18",       "Early_vs_Advanced_ResNet18_ensemble_predictions.csv"),
    ("ResNet50",           r"path\to\Binary\ResNet50",       "Early_vs_Advanced_ResNet50_ensemble_predictions.csv"),
    ("ResNet101",          r"path\to\Binary\ResNet101",      "Early_vs_Advanced_ResNet101_ensemble_predictions.csv"),
    ("DenseNet121",        r"path\to\Ensemble\Binary\DenseNet121",    "Early_vs_Advanced_DenseNet121_ensemble_predictions.csv"),
    ("ResNet50 pretrained",r"path\to\Ensemble\Binary\ResNet50_pretrained",    "Early_vs_Advanced_ResNet50_pretrained_ensemble_predictions.csv"),
]

N_FOLDS = 5
OUT_FIG = r"path\to\Ensemble\Binary\roc_overlays_Early_vs_Advanced.png"  # change name per task
...
fig.suptitle(
    r"$\mathbf{Validation\ (5\text{-}fold\ CV)\ vs\ Test\ ROC\ curves\ for\ all\ DL\ models\ for\ Early\ vs\ Advanced\ Classification\ task}$",
    fontsize=16,
    y=0.98
)
