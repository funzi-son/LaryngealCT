...
output_root = Path(r"path\to\Ensemble\Binary\ResNet50_pretrained")
pred_path   = output_root / "Early_vs_Advanced_ResNet50_pretrained_ensemble_predictions.csv"
metrics_path = output_root / "Early_vs_Advanced_ResNet50_pretrained_ensemble_test_metrics.json"
...
out_csv = output_root / "Early_vs_Advanced_ResNet50_pretrained_per_class_from_ensemble.csv"
