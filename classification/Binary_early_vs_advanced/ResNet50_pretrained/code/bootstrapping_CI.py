...
pred_path   = os.path.join(output_root, "Early_vs_Advanced_ResNet50_pretrained_ensemble_predictions.csv")
metrics_js  = os.path.join(output_root, "Early_vs_Advanced_ResNet50_pretrained_ensemble_test_metrics.json")
out_csv     = os.path.join(output_root, "Early_vs_Advanced_ResNet50_pretrained_raw_and_calibrated_bootstrap_CIs.csv")
out_xlsx    = os.path.join(output_root, "Early_vs_Advanced_ResNet50_pretrained_raw_and_calibrated_bootstrap_CIs.xlsx")
