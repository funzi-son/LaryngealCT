...
TEST_SPLIT  = r"paht\to\test_split_binary.xlsx"
...
def build_model():
    # Same as training: DenseNet121 with out_channels=2
...
print("\n=== ENSEMBLE TEST RESULTS (DenseNet121) ===")
...
pred_path = out_dir / "Early_vs_Advanced_DenseNet121_ensemble_predictions.csv"
...
metrics_path = out_dir / "Early_vs_Advanced_DenseNet121_ensemble_test_metrics.json"
