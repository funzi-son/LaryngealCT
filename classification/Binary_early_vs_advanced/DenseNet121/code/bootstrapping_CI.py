...
output_root = r"path\to\Ensemble\Binary\DenseNet121"

pred_path   = os.path.join(output_root, "Early_vs_Advanced_DenseNet121_ensemble_predictions.csv")
metrics_js  = os.path.join(output_root, "Early_vs_Advanced_DenseNet121_ensemble_test_metrics.json")
out_csv     = os.path.join(output_root, "Early_vs_Advanced_DenseNet121_raw_and_calibrated_bootstrap_CIs.csv")
out_xlsx    = os.path.join(output_root, "Early_vs_Advanced_DenseNet121_raw_and_calibrated_bootstrap_CIs.xlsx")
