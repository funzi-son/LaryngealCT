...
# Paths
base = r"path\to\Ensemble\Binary\DenseNet121"
pred_path  = base + r"\Early_vs_Advanced_DenseNet121_ensemble_predictions.csv"
metrics_js = base + r"\Early_vs_Advanced_DenseNet121_ensemble_test_metrics.json"
out_csv    = base + r"\Early_vs_Advanced_DenseNet121_raw_vs_calibrated_metrics.csv"
out_xlsx   = base + r"\Early_vs_Advanced_DenseNet121_raw_vs_calibrated_metrics.xlsx"
