...
df = pd.read_csv(r"path\to\Ensemble\Binary\ResNet101\Early_vs_Advanced_ResNet101_ensemble_predictions.csv")  # y_true, prob_raw, prob_cal
...
with open(r"path\to\Ensemble\Binary\ResNet101\Early_vs_Advanced_ResNet101_ensemble_test_metrics.json", "r") as f:
    metrics = json.load(f)
...
save_folder = r"path\to\Ensemble\Binary\ResNet101"
