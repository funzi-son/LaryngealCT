...
output_root = Path(r"path\to\Ensemble\Binary\ResNet101")
pred_path   = output_root / "Early_vs_Advanced_ResNet101_ensemble_predictions.csv"
metrics_path = output_root / "Early_vs_Advanced_ResNet101_ensemble_test_metrics.json"
...
out_csv = output_root / "Early_vs_Advanced_ResNet101_per_class_from_ensemble.csv"
