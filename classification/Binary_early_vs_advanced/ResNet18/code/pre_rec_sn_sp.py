...
# Paths
base = r"path\to\Ensemble\Binary\ResNet18"
pred_path  = base + r"\Early_vs_Advanced_ResNet18_ensemble_predictions.csv"
metrics_js = base + r"\Early_vs_Advanced_ResNet18_ensemble_test_metrics.json"
out_csv    = base + r"\Early_vs_Advanced_ResNet18_raw_vs_calibrated_metrics.csv"
out_xlsx   = base + r"\Early_vs_Advanced_ResNet18_raw_vs_calibrated_metrics.xlsx"
