# =============================================================
# Code to calculate 95% Confidence Interval using Bootstrapping
# =============================================================
...
output_root = r"path\to\Ensemble\Binary\3DCNN"

pred_path   = os.path.join(output_root, "Early_vs_Advanced_Custom3DCNN_ensemble_predictions.csv")
metrics_js  = os.path.join(output_root, "Early_vs_Advanced_Custom3DCNN_ensemble_test_metrics.json")
out_csv     = os.path.join(output_root, "Early_vs_Advanced_Custom3DCNN_raw_and_calibrated_bootstrap_CIs.csv")
out_xlsx    = os.path.join(output_root, "Early_vs_Advanced_Custom3DCNN_raw_and_calibrated_bootstrap_CIs.xlsx")
