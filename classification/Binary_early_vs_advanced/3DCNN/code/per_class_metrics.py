...
output_root = Path(r"patrh\to\Ensemble\Binary\3DCNN")
pred_path   = output_root / "Early_vs_Advanced_Custom3DCNN_ensemble_predictions.csv"
metrics_path = output_root / "Early_vs_Advanced_Custom3DCNN_ensemble_test_metrics.json"
...
out_csv = output_root / "Early_vs_Advanced_Custom3DCNN_per_class_from_ensemble.csv"
