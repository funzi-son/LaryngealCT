# =======================================================
# Code to save ROC overlays for Cross Validation and Test
# =======================================================
import numpy as np
...
cv_summary = json.load(open(out_dir/"cv_summary_custom3dcnn.json")) 
...
# ========================
test_preds = pd.read_csv(out_dir/"test_predictions_custom3dcnn.csv")  
