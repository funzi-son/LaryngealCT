# ==========================================================================
# Code to calculate Overall Test Precision, Recall, Sensitivity, Specificity
# ==========================================================================
...
# Paths
base = r"path\to\Ensemble\Binary\3DCNN"
pred_path  = base + r"\Early_vs_Advanced_Custom3DCNN_ensemble_predictions.csv"
metrics_js = base + r"\Early_vs_Advanced_Custom3DCNN_ensemble_test_metrics.json"
out_csv    = base + r"\Early_vs_Advanced_Custom3DCNN_raw_vs_calibrated_metrics.csv"
out_xlsx   = base + r"\Early_vs_Advanced_Custom3DCNN_raw_vs_calibrated_metrics.xlsx"
